function katespade_scraper() {
    var selected_color;
    let selected_color_dom = document.querySelector("ul.Color li.selected");
    ...
    var img_src = document.querySelector("img.primary-image").src;
    var regex = /[+-]?\d+(\.\d+)?/g;
    var price_dom = document.querySelector("#product-content .product-price.sale .promo-price");
    if (!price_dom) {
        price_dom = document.querySelector("#product-content .product-price");
    }
